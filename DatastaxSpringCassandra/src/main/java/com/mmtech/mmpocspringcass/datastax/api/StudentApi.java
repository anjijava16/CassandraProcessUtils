package com.mmtech.mmpocspringcass.datastax.api;

import com.datastax.driver.mapping.Result;
import com.mmtech.mmpocspringcass.datastax.model.Student;
import com.mmtech.mmpocspringcass.datastax.repository.StudentService;
...
public class StudentApi {
    ...
    public ResponseEntity<Object> searchStudentById(@ApiParam(name = "studentId",
        ...
        try {
            ...
            if (studentResult == null) {
                ...
                response = new ResponseEntity<Object>(studentResult.all(), HttpStatus.OK);
            }
        } catch (Exception ex) {
    ...
    public ResponseEntity<Object> createStudent(@RequestHeader(name = "departmentId") Integer departmentId,     @RequestParam String name,@RequestParam String address) {
